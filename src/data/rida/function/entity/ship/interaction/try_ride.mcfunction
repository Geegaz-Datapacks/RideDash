...
execute if score #rida.riders rida.var >= #rida.MAX_RIDERS rida.var on target run return run title @s actionbar {"translate":"rida.message.too_many_riders","fallback":"Too many riders - try again later"}
